...
//        //方法3：通过数组创建stream
//        Student[] studentsArr = (Student[]) getStudents().toArray();//转化为数组，并强转
//        Stream<Student> stream2 = Arrays.stream(studentsArr);//数组转化为流
         ...
         */
        //过滤出年龄小于22的同学
//        stream.filter(student -> student.getAge() < 22)//参数是随便的。student  stu
...
//                .map((  s) -> s.toUpperCase()  ) //转换成大写 //C3 C1 C2  作用在流里c1 c2 c3每个元素身上，执行转大写操作
//                .sorted() //排序  //C1 C2 C3
